...
Proper heat sinking is very important for the power stage. You can hardly even test the LM1875 chipamps if they are not heat sinked. I used an aluminum L bar which gave me space to mount both boards, but you can get by with significantly smaller heat sinks especially during testing.
