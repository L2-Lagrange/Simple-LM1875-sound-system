...
Below is my design for a simple, modular LM1875 bridge-tied-load (BTL) sound system. It is a practical analog amplifier system that is easy to build, has great performance, runs from a wide variety of DC power supplies, and makes for good educational material. 
...
<p align="center">
  <img src="Images/System_Image.png" width="400"><br>
  <em>Schematic:  Image of prototype </em>
</p>
...
The most important feature of the receiver board is the 2nd order ~35khz cutoff filter. This is what allows us to use various bluetooth receivers, or arbitrary signal sources. The noise is technically higher than audiable frequency, but its good design to get rid of it. (The topography originally came from a Texas Instruments design manual, but they have removed it from the internet. I redesigned it for 35khz and this version works well for audio.)
